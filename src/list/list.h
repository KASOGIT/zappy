...
** Last update Sun Jun 26 21:19:17 2016 
*/
...
typedef struct	s_list
{
  ...
  int		(*any_of)(struct s_list *this,
			  ...
			  void *to_cmp);
  int		(*is_match_pred)(struct s_list *this, int (*pred)(void *arg));
  int		(*count_match_pred)(struct s_list *this, int (*pred)(void *arg));
  int		(*count_match_pred_args)(struct s_list *this, int (*pred)
			(void *data, va_list ap), ...);
  void		*(*get_elem)(struct s_list *this, int pos);
  void		*(*get_elem_by_pred)(struct s_list *this,
				     int (*pred)(void *data));
...
void	list_error(t_list *this, const char *fun,
		   const char *file, int line);
void	list_warning(t_list *this, const char *fun,
		     const char *file, int line);
