...
set(Qt53DInput_VERSION_STRING 5.6.1)
...
macro(_populate_3DInput_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DInput PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DInput.so"
...
if (NOT TARGET Qt5::3DInput)
    ...
    set(Qt53DInput_PRIVATE_INCLUDE_DIRS
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.6.1"
        "${_qt53DInput_install_prefix}/include/Qt3DInput/5.6.1/Qt3DInput"
    )
    ...
    foreach(_module_dep ${_Qt53DInput_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.1 ${_Qt53DInput_FIND_VERSION_EXACT}
    ...
    _populate_3DInput_target_properties(RELEASE "libQt53DInput.so" "" )
