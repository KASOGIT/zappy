...
set(Qt53DRender_VERSION_STRING 5.6.1)
...
macro(_populate_3DRender_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DRender PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DRender.so"
...
if (NOT TARGET Qt5::3DRender)
    ...
    set(Qt53DRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.6.1"
        "${_qt53DRender_install_prefix}/include/Qt3DRender/5.6.1/Qt3DRender"
    )
    ...
    foreach(_module_dep ${_Qt53DRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.1 ${_Qt53DRender_FIND_VERSION_EXACT}
    ...
    _populate_3DRender_target_properties(RELEASE "libQt53DRender.so" "" )
