...
set(Qt53DCore_VERSION_STRING 5.6.1)
...
macro(_populate_3DCore_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DCore PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DCore.so"
...
if (NOT TARGET Qt5::3DCore)
    ...
    set(Qt53DCore_PRIVATE_INCLUDE_DIRS
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.6.1"
        "${_qt53DCore_install_prefix}/include/Qt3DCore/5.6.1/Qt3DCore"
    )
    ...
    foreach(_module_dep ${_Qt53DCore_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.1 ${_Qt53DCore_FIND_VERSION_EXACT}
    ...
    _populate_3DCore_target_properties(RELEASE "libQt53DCore.so" "" )
