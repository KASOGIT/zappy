...
set(Qt53DQuick_VERSION_STRING 5.6.1)
...
macro(_populate_3DQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::3DQuick PROPERTIES
        ...
        "IMPORTED_SONAME_${Configuration}" "libQt53DQuick.so"
...
if (NOT TARGET Qt5::3DQuick)
    ...
    set(Qt53DQuick_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.6.1"
        "${_qt53DQuick_install_prefix}/include/Qt3DQuick/5.6.1/Qt3DQuick"
    )
    ...
    foreach(_module_dep ${_Qt53DQuick_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.6.1 ${_Qt53DQuick_FIND_VERSION_EXACT}
    ...
    _populate_3DQuick_target_properties(RELEASE "libQt53DQuick.so" "" )
